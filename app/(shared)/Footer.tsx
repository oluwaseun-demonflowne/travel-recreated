        ...
        <div className='flex md:flex-row flex-col md:gap-0 gap-4 justify-around mb-5 md:mb-16 bottom-2'>
            <div className='flex flex-col md:p-6 gap-2'>
                ...
                <div className='flex flex-col gap-1'>
                    <p className='flex flex-col gap-1 text-base font-bold text-slate-400'>Customer Support</p>
                    <h1 className='text-base font-black'>(239) 555-0108</h1>
                </div>
                <div className='flex flex-col gap-1'>
                    <p className='flex flex-col gap-1 text-base font-bold text-slate-400'>Need Live Support</p>
            ...
            <div className='flex flex-col md:p-6 gap-2'>
                ...
                <div className='flex flex-col gap-1 text-base font-bold text-slate-400'>
