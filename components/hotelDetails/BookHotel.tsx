  ...
  return (
    <div className='flex flex-col items-center gap-5'>
        <form  className='border w-72 py-2  rounded-2xl flex flex-col gap-3'>
            ...
            <div className='flex border-b-2 justify-between p-2 items-center'>
                <div>
                    <p className='text-sm font-bold'>Room No</p>
            ...
            <div className='p-2 flex flex-col gap-2'>
                ...
                <div className='flex flex-col gap-2 mt-3 mb-2 border-b-2 py-2'>
                    <div className='flex justify-between items-center'>
                        <p className='text-xs'>${data?.price} * {night} night</p>
                        <p className='text-xs font-black'>${data?.price * night}</p>
                    </div>
                    <div className='flex justify-between items-center'>
                ...
                <div>
                    <div className='flex justify-between items-center'>
                        ...
                        <p className='text-xs font-black'>${(data?.price * night) + 150}</p>
                    </div>
                </div>
                {<button type='submit' className='p-2 border w-full bg-blue-700 text-white text-xs rounded-full'>Book</button> 
