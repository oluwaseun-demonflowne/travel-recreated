    ...
    <div className='md:flex items-center gap-4 md:gap-2'> 
        <div className='md:border-r-2 gap-2 flex md:gap-1 items-center p-2'>
            ...
            <div className='w-[190px] '>
                ...
                <input type='text' required className='rounded-md outline-none border w-48 h-10 text-xs p-2'/>
            </div>
        </div>
        <div className='md:border-r-2 gap-2 flex md:gap-1 items-center p-2'>
            <GoPerson />
            <div className='w-[190px] '>
                <p className='text-sm font-bold'>No of Passenger<span className='font-light'>(optional)</span></p>
