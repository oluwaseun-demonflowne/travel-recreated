...
const Work = () => {
  return (
    <div className='bg-[rgb(241,245,246)] text-center my-5 py-5'>
        ...
        <p className='text-[10px] mb-4'>keep calm and travel on</p>
        <div className='flex md:flex-row flex-col items-center gap-5 mb-5 justify-center'>
            <div className='bg-white text-center border w-44 h-56 px-4 rounded-full flex flex-col justify-center items-center gap-3'>
                ...
                <p className='text-xs text-slate-600'>Throughout the customer trip, the travel agency would provide support.</p>
            </div>
            <div className='bg-white text-center border w-44 h-56 px-4 rounded-full flex flex-col justify-center items-center gap-3'>
                <div className='bg-[rgb(58,94,206)] w-12 h-12 flex justify-center items-center rounded-full'>
